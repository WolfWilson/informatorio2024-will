...
ICON_PATH = os.path.join(BASE_DIR, "src", "iconh.ico")
BACKGROUND_IMAGE_PATH = os.path.join(BASE_DIR, "src", "fondo2.png")
FONT_PATH = os.path.join(BASE_DIR, "src", "fonts", "Roboto-Regular.ttf")
...
class Ahorcado:
    ...
    def setup_ui(self):
        ...
        tk.Label(self.canvas, text="Seleccione una temática:", font=self.custom_font, bg="#ffffff").place(x=20, y=20)
        y_offset = 60
        ...
        self.label_intentos = tk.Label(self.canvas, text=f"Intentos restantes: {self.intentos_restantes}", font=self.custom_font, bg="#ffffff")
        self.label_intentos.place(x=130, y=300)

        # Mostrar progreso (centrado) - ReadOnly
        self.label_progreso = tk.Label(self.canvas, text="Progreso:", font=self.custom_font, bg="#ffffff")
        ...
        self.entrada_letra = tk.Entry(self.canvas, font=self.custom_font)
